...
CREATE TABLE [dbo].[Authority] (
    ...
    [authorityStatusId] NVARCHAR(1000),
...
-- AddForeignKey
ALTER TABLE [dbo].[Authority] ADD CONSTRAINT [Authority_authorityStatusId_fkey] FOREIGN KEY ([authorityStatusId]) REFERENCES [dbo].[AuthorityStatus]([id]) ON DELETE SET NULL ON UPDATE CASCADE;
