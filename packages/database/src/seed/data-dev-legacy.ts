...
import { ACT_ID, CASE_TYPES_ID } from './static-data/ids/index.ts';
import { LEGACY_CONTACT_TYPE_ID, LEGACY_SECTION_ID } from './static-data/legacy/ids/index.ts';
...
export async function seedDevLegacyCase(dbClient: PrismaClient) {
	...
	await dbClient.case.upsert({
		...
		create: {
			...
			historicalReference: 'HORIZON/HIST/REF/0001',
