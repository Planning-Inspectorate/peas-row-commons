...
class CaseReceivedDatePage {
	...
	/**
	 * Enters the supplied date, or a generated test date when none is provided,
	 * and returns the value used.
	 */
	...
	/**
	 * Verifies the expected summary and inline validation errors for a given date input error state.
	 */
